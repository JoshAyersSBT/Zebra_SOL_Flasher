...
class FlashDeployTab(QWidget):
    ...
    def _build(self):
        ...
        deploy_help = QLabel(
            ...
            "Leave Serial Port set to AUTO to scan for likely ESP32 ports on Windows, macOS, or Linux, "
            "or enter a specific port manually. Choose Serial to copy with mpremote, or BLE to upload the same code set over Bluetooth."
        )
    ...
    def set_busy(self, busy: bool):
        ...
        self.btn_scan_ports.setEnabled(not busy)
